...
export const translations: Record<Language, Translations> = {
  ...
  es: {
    ...
    // Hero
    heroBadge: "Más de 24 años de liderazgo e ingeniería comprobada",
    heroTitlePrefix: "Truck Fuel Boost: ",
    heroTitleGradient: "Ahorro de Combustible y Mayor Par Motor",
    heroSubtitle: "Somos fabricantes de software de última generación para computadoras de motor (ECU). Optimizamos la entrega de par a menores revoluciones, logrando reducciones reales de diésel de 3% al 5% en promedio de flota y hasta un 18% en vehículos específicos, con resultados comprobables en tiempo real mediante telemetría.",
    heroSubtitleHighlight1: "3% al 5% en promedio de flota",
    heroSubtitleHighlight2: "hasta un 18% en vehículos específicos",
    heroCtaDemo: "Solicitar Demo Gratuita",
    heroCtaCalc: "Calcular Ahorro de mi Flota",
    metric1Val: "3% - 5%",
    metric1Label: "Ahorro promedio de flota (hasta 18% en unidades severas)",
    metric2Val: "24+ Años",
